...
function firstPage(){
	if(currentPage == 1){
		...
		submitForm("<%=context %>/sublist/Sublist?pageNum=1");
		return true;
	}
}
...
function nextPage(){
	if(currentPage == totalPage){
		...
		submitForm("<%=context %>/sublist/Sublist?pageNum=" + (currentPage+1));
		return true;
	}
}
...
function lastPage(){
	if(currentPage == totalPage){
		...
		submitForm("<%=context %>/sublist/Sublist?pageNum=${result.totalPage}");
		return true;
	}
}
function initPage(){
...
<body onload="initPage();">
	<div style="margin-left: 100px; margin-top: 100px;">
		...
		<div>
			<form action="<%=context %>/sublist/sublist.jsp"   id="stuForm"  method="post">
				姓名
